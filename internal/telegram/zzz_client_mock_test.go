...
//go:generate minimock -i github.com/denisdubovitskiy/feedparser/internal/telegram.Client -o ./zzz_client_mock_test.go -n ClientMock
...
func (mmSend *mClientMockSend) Expect(c tgbotapi.Chattable) *mClientMockSend {
	...
	mmSend.defaultExpectation.params = &ClientMockSendParams{c}
...
func (mmSend *mClientMockSend) Inspect(f func(c tgbotapi.Chattable)) *mClientMockSend {
...
func (mmSend *mClientMockSend) Return(m1 tgbotapi.Message, err error) *ClientMock {
	if mmSend.mock.funcSend != nil {
		mmSend.mock.t.Fatalf("ClientMock.Send mock is already set by Set")
	}
	...
	mmSend.defaultExpectation.results = &ClientMockSendResults{m1, err}
	return mmSend.mock
}

// Set uses given function f to mock the Client.Send method
func (mmSend *mClientMockSend) Set(f func(c tgbotapi.Chattable) (m1 tgbotapi.Message, err error)) *ClientMock {
	if mmSend.defaultExpectation != nil {
...
// Then helper
func (mmSend *mClientMockSend) When(c tgbotapi.Chattable) *ClientMockSendExpectation {
	if mmSend.mock.funcSend != nil {
		mmSend.mock.t.Fatalf("ClientMock.Send mock is already set by Set")
	}
...
func (e *ClientMockSendExpectation) Then(m1 tgbotapi.Message, err error) *ClientMock {
	e.results = &ClientMockSendResults{m1, err}
	return e.mock
}

// Send implements Client
func (mmSend *ClientMock) Send(c tgbotapi.Chattable) (m1 tgbotapi.Message, err error) {
	...
	mm_params := &ClientMockSendParams{c}
	...
	mmSend.t.Fatalf("Unexpected call to ClientMock.Send. %v", c)
	return
}
